...
cat $data | awk '{print $1,$2,$5}' | gmt nearneighbor $range -I0.05 -S100k -G$grdname 
...
gmt psscale -R -J -DJCM+w2.35i/0.12i+o1.8i/0i+v   -Ctmp.cpt -Bxa0.5f0.5 -By+l"km/s" -G$cptrange  -O   >>$PS
